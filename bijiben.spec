...
Version  : 3.34.1
Release  : 6
URL      : https://download.gnome.org/sources/bijiben/3.34/bijiben-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/bijiben/3.34/bijiben-3.34.1.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571141341
...
cp %{_builddir}/bijiben-3.34.1/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
