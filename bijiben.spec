...
Version  : 3.37.92
Release  : 12
URL      : https://download.gnome.org/sources/bijiben/3.37/bijiben-3.37.92.tar.xz
Source0  : https://download.gnome.org/sources/bijiben/3.37/bijiben-3.37.92.tar.xz
...
%prep
%setup -q -n bijiben-3.37.92
cd %{_builddir}/bijiben-3.37.92
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600356781
...
cp %{_builddir}/bijiben-3.37.92/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
...
/usr/share/help/ca/bijiben/figures/hicolor_apps_48x48_bijiben.png
