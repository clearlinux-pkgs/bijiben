...
Source0  : https://download.gnome.org/sources/bijiben/40/bijiben-40.0.tar.xz
...
%prep
%setup -q -n bijiben-40.0
cd %{_builddir}/bijiben-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619150842
...
cp %{_builddir}/bijiben-40.0/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
