...
Source0  : https://download.gnome.org/sources/bijiben/3.34/bijiben-3.34.2.tar.xz
...
%prep
%setup -q -n bijiben-3.34.2
cd %{_builddir}/bijiben-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578328392
...
cp %{_builddir}/bijiben-3.34.2/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
