...
%prep
%setup -q -n bijiben-3.38.0
cd %{_builddir}/bijiben-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600650501
...
cp %{_builddir}/bijiben-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
...
/usr/share/help/fur/bijiben/figures/hicolor_apps_48x48_bijiben.png
