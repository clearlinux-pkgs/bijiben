...
Version  : 3.36.0
Release  : 8
URL      : https://download.gnome.org/sources/bijiben/3.36/bijiben-3.36.0.tar.xz
Source0  : https://download.gnome.org/sources/bijiben/3.36/bijiben-3.36.0.tar.xz
...
%prep
%setup -q -n bijiben-3.36.0
cd %{_builddir}/bijiben-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585611961
...
cp %{_builddir}/bijiben-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/bijiben/338650eb7a42dd9bc1f1c6961420f2633b24932d
